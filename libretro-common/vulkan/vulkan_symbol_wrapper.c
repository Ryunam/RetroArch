...
PFN_vkWaitForPresent2KHR vulkan_symbol_wrapper_vkWaitForPresent2KHR;
PFN_vkQueueNotifyOutOfBandNV vulkan_symbol_wrapper_vkQueueNotifyOutOfBandNV;
PFN_vkSetLatencySleepModeNV vulkan_symbol_wrapper_vkSetLatencySleepModeNV;
PFN_vkLatencySleepNV vulkan_symbol_wrapper_vkLatencySleepNV;
PFN_vkSetLatencyMarkerNV vulkan_symbol_wrapper_vkSetLatencyMarkerNV;
PFN_vkGetLatencyTimingsNV vulkan_symbol_wrapper_vkGetLatencyTimingsNV;
