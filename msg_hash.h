...
enum msg_hash_enums
{
   ...
   MENU_LBL_H(VIDEO_BUFFER_COUNT),
   MENU_LABEL(VIDEO_SEQUENTIAL_SWAPCHAIN),
   MENU_LABEL(VIDEO_WAITABLE_SWAPCHAINS),
   MENU_LABEL(VIDEO_WAIT_FOR_PRESENT),
   MENU_LABEL(VIDEO_UNLIMITED_WAIT),
   MENU_LABEL(VIDEO_LOW_LATENCY),
