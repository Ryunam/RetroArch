...
enum menu_timedate_style_dash_type
{
   MENU_TIMEDATE_STYLE_DASH_YMD_HMS = 0,
   MENU_TIMEDATE_STYLE_DASH_YMD_HM,
   MENU_TIMEDATE_STYLE_DASH_YMD,
   MENU_TIMEDATE_STYLE_DASH_YM,
   MENU_TIMEDATE_STYLE_DASH_MDYYYY_HMS,
   MENU_TIMEDATE_STYLE_DASH_MDYYYY_HM,
   MENU_TIMEDATE_STYLE_DASH_MD_HM,
   MENU_TIMEDATE_STYLE_DASH_MDYYYY,
   MENU_TIMEDATE_STYLE_DASH_MD,
   MENU_TIMEDATE_STYLE_DASH_DDMMYYYY_HMS,
   MENU_TIMEDATE_STYLE_DASH_DDMMYYYY_HM,
   MENU_TIMEDATE_STYLE_DASH_DDMM_HM,
   MENU_TIMEDATE_STYLE_DASH_DDMMYYYY,
   MENU_TIMEDATE_STYLE_DASH_DDMM,
   MENU_TIMEDATE_STYLE_DASH_HMS,
   MENU_TIMEDATE_STYLE_DASH_HM,
   MENU_TIMEDATE_STYLE_DASH_YMD_HMS_AMPM,
   MENU_TIMEDATE_STYLE_DASH_YMD_HM_AMPM,
   MENU_TIMEDATE_STYLE_DASH_MDYYYY_HMS_AMPM,
   MENU_TIMEDATE_STYLE_DASH_MDYYYY_HM_AMPM,
   MENU_TIMEDATE_STYLE_DASH_MD_HM_AMPM,
   MENU_TIMEDATE_STYLE_DASH_DDMMYYYY_HMS_AMPM,
   MENU_TIMEDATE_STYLE_DASH_DDMMYYYY_HM_AMPM,
   MENU_TIMEDATE_STYLE_DASH_DDMM_HM_AMPM,
   MENU_TIMEDATE_STYLE_DASH_HMS_AMPM,
   MENU_TIMEDATE_STYLE_DASH_HM_AMPM,
   MENU_TIMEDATE_STYLE_DASH_LAST
};

enum menu_timedate_style_slash_type
{
   MENU_TIMEDATE_STYLE_SLASH_YMD_HMS = 0,
   MENU_TIMEDATE_STYLE_SLASH_YMD_HM,
   MENU_TIMEDATE_STYLE_SLASH_YMD,
   MENU_TIMEDATE_STYLE_SLASH_YM,
   MENU_TIMEDATE_STYLE_SLASH_MDYYYY_HMS,
   MENU_TIMEDATE_STYLE_SLASH_MDYYYY_HM,
   MENU_TIMEDATE_STYLE_SLASH_MD_HM,
   MENU_TIMEDATE_STYLE_SLASH_MDYYYY,
   MENU_TIMEDATE_STYLE_SLASH_MD,
   MENU_TIMEDATE_STYLE_SLASH_DDMMYYYY_HMS,
   MENU_TIMEDATE_STYLE_SLASH_DDMMYYYY_HM,
   MENU_TIMEDATE_STYLE_SLASH_DDMM_HM,
   MENU_TIMEDATE_STYLE_SLASH_DDMMYYYY,
   MENU_TIMEDATE_STYLE_SLASH_DDMM,
   MENU_TIMEDATE_STYLE_SLASH_HMS,
   MENU_TIMEDATE_STYLE_SLASH_HM,
   MENU_TIMEDATE_STYLE_SLASH_YMD_HMS_AMPM,
   MENU_TIMEDATE_STYLE_SLASH_YMD_HM_AMPM,
   MENU_TIMEDATE_STYLE_SLASH_MDYYYY_HMS_AMPM,
   MENU_TIMEDATE_STYLE_SLASH_MDYYYY_HM_AMPM,
   MENU_TIMEDATE_STYLE_SLASH_MD_HM_AMPM,
   MENU_TIMEDATE_STYLE_SLASH_DDMMYYYY_HMS_AMPM,
   MENU_TIMEDATE_STYLE_SLASH_DDMMYYYY_HM_AMPM,
   MENU_TIMEDATE_STYLE_SLASH_DDMM_HM_AMPM,
   MENU_TIMEDATE_STYLE_SLASH_HMS_AMPM,
   MENU_TIMEDATE_STYLE_SLASH_HM_AMPM,
   MENU_TIMEDATE_STYLE_SLASH_LAST
};

enum menu_timedate_style_dot_type
{
   MENU_TIMEDATE_STYLE_DOT_YMD_HMS = 0,
   MENU_TIMEDATE_STYLE_DOT_YMD_HM,
   MENU_TIMEDATE_STYLE_DOT_YMD,
   MENU_TIMEDATE_STYLE_DOT_YM,
   MENU_TIMEDATE_STYLE_DOT_MDYYYY_HMS,
   MENU_TIMEDATE_STYLE_DOT_MDYYYY_HM,
   MENU_TIMEDATE_STYLE_DOT_MD_HM,
   MENU_TIMEDATE_STYLE_DOT_MDYYYY,
   MENU_TIMEDATE_STYLE_DOT_MD,
   MENU_TIMEDATE_STYLE_DOT_DDMMYYYY_HMS,
   MENU_TIMEDATE_STYLE_DOT_DDMMYYYY_HM,
   MENU_TIMEDATE_STYLE_DOT_DDMM_HM,
   MENU_TIMEDATE_STYLE_DOT_DDMMYYYY,
   MENU_TIMEDATE_STYLE_DOT_DDMM,
   MENU_TIMEDATE_STYLE_DOT_HMS,
   MENU_TIMEDATE_STYLE_DOT_HM,
   MENU_TIMEDATE_STYLE_DOT_YMD_HMS_AMPM,
   MENU_TIMEDATE_STYLE_DOT_YMD_HM_AMPM,
   MENU_TIMEDATE_STYLE_DOT_MDYYYY_HMS_AMPM,
   MENU_TIMEDATE_STYLE_DOT_MDYYYY_HM_AMPM,
   MENU_TIMEDATE_STYLE_DOT_MD_HM_AMPM,
   MENU_TIMEDATE_STYLE_DOT_DDMMYYYY_HMS_AMPM,
   MENU_TIMEDATE_STYLE_DOT_DDMMYYYY_HM_AMPM,
   MENU_TIMEDATE_STYLE_DOT_DDMM_HM_AMPM,
   MENU_TIMEDATE_STYLE_DOT_HMS_AMPM,
   MENU_TIMEDATE_STYLE_DOT_HM_AMPM,
   MENU_TIMEDATE_STYLE_DOT_LAST
};

enum menu_timedate_separator_type
{
   MENU_TIMEDATE_SEPARATOR_DASH = 0,
   MENU_TIMEDATE_SEPARATOR_SLASH,
   MENU_TIMEDATE_SEPARATOR_DOT,
   MENU_TIMEDATE_SEPARATOR_LAST
};
