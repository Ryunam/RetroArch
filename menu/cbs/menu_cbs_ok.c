...
static enum msg_hash_enums action_ok_dl_to_enum(unsigned lbl)
{
   switch (lbl)
   {
      ...
      case ACTION_OK_DL_ONSCREEN_INDICATORS_SETTINGS_LIST:
         return MENU_ENUM_LABEL_DEFERRED_ONSCREEN_INDICATORS_SETTINGS_LIST;
...
STATIC_DEFAULT_ACTION_OK_FUNC(action_ok_onscreen_indicators_list, ACTION_OK_DL_ONSCREEN_INDICATORS_SETTINGS_LIST)
      ...
      const char *label)
{
   ...
   if (cbs->enum_idx != MSG_UNKNOWN)
   {
      ...
      static const temp_ok_list_t ok_list[] = {
         ...
         {MENU_ENUM_LABEL_ONSCREEN_INDICATORS_SETTINGS,        action_ok_onscreen_indicators_list},
