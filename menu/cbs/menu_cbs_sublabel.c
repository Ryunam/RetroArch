...
DEFAULT_SUBLABEL_MACRO(action_bind_sublabel_run_ahead,                     MENU_ENUM_SUBLABEL_RUN_AHEAD)
DEFAULT_SUBLABEL_MACRO(action_bind_sublabel_run_ahead_frames,              MENU_ENUM_SUBLABEL_RUN_AHEAD_FRAMES)
DEFAULT_SUBLABEL_MACRO(action_bind_sublabel_run_ahead_show_warnings,       MENU_ENUM_SUBLABEL_RUN_AHEAD_SHOW_WARNINGS)
      ...
      switch (cbs->enum_idx)
      {
        ...
        case MENU_ENUM_LABEL_PLAY_REPLAY:
         ...
         case MENU_ENUM_LABEL_RUN_AHEAD_UNSUPPORTED:
            ...
            break;
         case MENU_ENUM_LABEL_RUN_AHEAD:
            BIND_ACTION_SUBLABEL(cbs, action_bind_sublabel_run_ahead);
            break;
         case MENU_ENUM_LABEL_RUN_AHEAD_FRAMES:
            BIND_ACTION_SUBLABEL(cbs, action_bind_sublabel_run_ahead_frames);
            break;
         case MENU_ENUM_LABEL_RUN_AHEAD_SHOW_WARNINGS:
            BIND_ACTION_SUBLABEL(cbs, action_bind_sublabel_run_ahead_show_warnings);
            break;
